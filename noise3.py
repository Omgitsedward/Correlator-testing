...
#Currently testing 4 input 1 ADC (noise3_2016-8-9-1406.bof)
...
plt.plot(fn,magac1,'c')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of AC of 1')
plt.plot(fn,phaseac1,'c')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magac3,'c')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of AC of 3')
plt.plot(fn,phaseac3,'c')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magcc01,'r')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of CC of 0 & 1')
plt.plot(fn,phasecc01,'r')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magcc03,'r')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of CC of 0 & 3')
plt.plot(fn,phasecc03,'r')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magcc12,'r')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of CC of 1 & 2')
plt.plot(fn,phasecc12,'r')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magcc13,'r')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of CC of 1 & 3')
plt.plot(fn,phasecc13,'r')
plt.ylabel('Phase in Degrees')
plt.grid(True)
...
plt.plot(fn,magcc23,'r')
plt.ylabel('Power (Arbitrary Units)')
plt.grid(True)
plt.subplot(212)
plt.title('Phase Response of CC of 2 & 3')
plt.plot(fn,phasecc23,'r')
plt.ylabel('Phase in Degrees')
plt.grid(True)
